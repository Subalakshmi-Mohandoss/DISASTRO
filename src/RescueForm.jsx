...
function RescueForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    severity: "",
    disasterType: "",
    goods: [{ name: "", count: "" }], // Array to hold goods and their counts
    locationImage: "", // Store Base64 string here
    latitude: "",
    longitude: "",
  });
  ...
  const extractCoordinates = (text) => {
    const latMatch = text.match(/Lat\s*([0-9.°-]+)/);
    const longMatch = text.match(/Long\s*([0-9.°-]+)/);
          ...
          <div className="form-field">
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              <button
                ...
                style={{ backgroundColour: "rgba(16, 4, 56, 0.9)" }}
              >
                Add Product
              </button>
              <button
          ...
          <div className="buttons">
            <button
              ...
              style={{
                ...
                height: "50px",
                marginRight: "20px",
                backgroundColor: "rgba(96, 13, 13, 0.9)",
              }}
            >
              Location Image
            </button>
